...
// CSP-safe.
// Lazy so merely importing ata never touches the filesystem. Bundlers that stub
// `fs`/`path` for the browser would otherwise crash at module load; the read is
// deferred to the first standalone compile that actually embeds the engine.
